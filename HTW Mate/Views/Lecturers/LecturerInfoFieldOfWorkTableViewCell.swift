//
//  LecturerInfoFieldOfWorkTableViewCell.swift
//  HTW Mate
//
...
class LecturerInfoFieldOfWorkTableViewCell : LecturerInfoTableViewCell {
    ...
    override func setupUI(withHeadline headline: String? = nil) {
        super.setupUI(withHeadline: HWStrings.Controllers.Lecturers.Detail.sectionFieldOfWork)
    ...
    override func reload() {
        ...
        lecturer.fieldOfWork.render(in: genericContentView)
    }
