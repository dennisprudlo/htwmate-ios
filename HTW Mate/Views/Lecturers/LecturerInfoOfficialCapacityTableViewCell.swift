//
//  LecturerInfoOfficialCapacityTableViewCell.swift
//  HTW Mate
//
...
class LecturerInfoOfficialCapacityTableViewCell : LecturerInfoTableViewCell {
    ...
    override func setupUI(withHeadline headline: String? = nil) {
        super.setupUI(withHeadline: HWStrings.Controllers.Lecturers.Detail.sectionOfficialCapacity)
    ...
    override func reload() {
        ...
        lecturer.officialCapacity.render(in: genericContentView)
    }
