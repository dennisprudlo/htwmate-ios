//
//  LecturerInfoOfficeHoursTableViewCell.swift
//  HTW Mate
//
...
class LecturerInfoOfficeHoursTableViewCell : LecturerInfoTableViewCell {
    ...
    override func setupUI(withHeadline headline: String? = nil) {
        super.setupUI(withHeadline: HWStrings.Controllers.Lecturers.Detail.sectionOfficeHours)
    ...
    override func reload() {
        ...
        lecturer.officeHours.render(in: genericContentView)
    }
