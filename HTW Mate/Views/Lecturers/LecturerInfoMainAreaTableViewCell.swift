//
//  LecturerInfoMainAreaTableViewCell.swift
//  HTW Mate
//
...
class LecturerInfoMainAreaTableViewCell : LecturerInfoTableViewCell {
    ...
    override func setupUI(withHeadline headline: String? = nil) {
        super.setupUI(withHeadline: HWStrings.Controllers.Lecturers.Detail.sectionMainArea)
    ...
    override func reload() {
        ...
        lecturer.mainArea.render(in: genericContentView)
    }
